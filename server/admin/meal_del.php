...
<body>
<table border="1" align="left" width="586" id="rounded-corner" summary="2007 Major IT Companies' Profit">
  <thead>
    <tr>
...
while($row = mysql_fetch_row($rs)) 
	...
	<tr>
      <td><a href='meal_del_sql.php?m_id=$row[0]'><img src='images/trash.png' alt='' title='' border='0' /></a></td>
